 ...
 */
export { MontevideoClient, PendienteDeSpec, BASE_URL, PLAYAS_PATH, mapearBus, mapearPlaya, mapearCasilla } from './cliente.js';
...
export type { Bus, BusCrudo, Parada, Arribo, Playa, Casilla } from './tipos.js';
